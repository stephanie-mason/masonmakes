$(document).ready(function(){
  ...
  var science = new Section("galaxy.jpg", "aqua", "white", 1);
  var textiles = new Section("threedee.jpg", "aqua", "black", 2);
  var code = new Section("muzak.jpg", "lime", "black", 3);
  var electronics = new Section("glitchlich.jpg", "lime", "white", 4);
  var web = new Section("pank.jpg", "magenta", "black", 5);
